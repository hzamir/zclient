...
//------------------------------------------------------------------------------
export function isFunction(a) {return typeof a === 'function';                           }
export function isObject(a)   {return (a && typeof a === 'object') || isFunction(a);     }
export function isAlien(a)    {return isObject(a) && typeof a.constructor !== 'function';}
export function isArray(a)    {return !!(a && (a.constructor === Array));                }
export function isBoolean(a)  {return typeof a === 'boolean';                            }
export function isNull(a)     {return a === null;                                        }
export function isNumber(a)   {return typeof a === 'number' && isFinite(a);              }
export function isString(a)   {return typeof a === 'string';                             }
export function isUndefined(a){return a === undefined;                                   }

export function nada() {}

// crockford's object function with more suggestive name
export function inherits(o) {
    function F() {}
    F.prototype = o;
    return new F();
}
...
export function assert(expr, more)
{
    let caught;
    try {
